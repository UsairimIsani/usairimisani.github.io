<template>
  ...
  >
    <header
      class="top-0 left-0 z-40 fixed w-full border-t-14 border-purple-700"
    >
      <nav
        class="
          container
    ...
    <footer class="bg-purple-700 text-white">
      ...
      >
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a
              href="https://youtube.com/qualism"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
